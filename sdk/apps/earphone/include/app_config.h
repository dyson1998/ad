...
#if (SYS_VOL_TYPE == VOL_TYPE_ANALOG) || (SYS_VOL_TYPE == VOL_TYPE_AD)
...
#define AUDIO_CVP_CODE_NS_AT_RAM		0
#define AUDIO_CVP_CODE_DNS_AT_RAM		0
#define AUDIO_CVP_CODE_DMS_AT_RAM		0
#define AUDIO_CVP_CODE_WIND_AT_RAM		0
#define AUDIO_CVP_CODE_AGC_AT_RAM		0
#define AUDIO_CVP_CODE_COMMON_AT_RAM	0
#define AUDIO_CVP_CODE_TEXT_AT_RAM		0
#else
/*通话语音处理算法放在.data段(ram)*/
/*-----------子模块.data段配置START-----------*/
...
#define AUDIO_CVP_CODE_COMMON_AT_RAM	1	//common lib 双麦 - 2.8k 单麦 - 4k
#define AUDIO_CVP_CODE_TEXT_AT_RAM		1	//common text 下行降噪开 - 6.9k 下行降噪关 - 4.6k
/*-----------子模块.data段配置END-------------*/
