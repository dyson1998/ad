...
#define TONE_LOW_LATENCY_IN     SDFILE_RES_ROOT_PATH"tone/game.*"//DEFAULT_SINE_TONE(SINE_WTONE_LOW_LATENRY_IN)
#define TONE_LOW_LATENCY_OUT    SDFILE_RES_ROOT_PATH"tone/music.*"//DEFAULT_SINE_TONE(SINE_WTONE_LOW_LATENRY_OUT)
